...
Installed 3 template(s) from pack `ips-core`:
...
starter set - currently the three starter templates `vital_signs_encounter.v1`,
`problem_list.v1` and `adverse_reaction_list.v1`.
