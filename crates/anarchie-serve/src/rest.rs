...
//! promise). It is a thin translation onto [`crate::ops`]; it owns no data.
//!
...
use anarchie_query::Params;
use anarchie_store::Deployment;
use serde_json::Value;
use tiny_http::{Header, Method, Request, Response, Server};

use crate::ops::{self, ApiError, Committer};
...
fn commit_reply(status: u16, ehr_id: &str, committed: crate::ops::Committed) -> Reply {
