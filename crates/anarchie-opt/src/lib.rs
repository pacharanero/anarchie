...
//! # anarchie-opt
//!
//! Loads a flattened **Operational Template** into the [`anarchie_aom`]
...
//! amount of identifying metadata plus a [`CComplexObject`](anarchie_aom::CComplexObject)
...
use anarchie_aom::CComplexObject;
