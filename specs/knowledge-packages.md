...
- [ ] **K3 - Manifest and lock.** Implement `knowledge.toml`, deterministic resolution, `knowledge.lock`, package policies, dependency explanations, update diffs, and offline cache behaviour.
